<!-- Captured 2026-08-26 from https://code.claude.com/docs/en/hooks.md (verbatim; one canonical copy per PROMPT_Harness_Phase0_2026-08-22.md §0.7). Re-fetch before trusting for API details. -->
> ## Documentation Index

...
| ARC-AGI Toolkit + benchmarking repo (arcprize) | `ARC_toolkit_notes.md` (+ `_raw/arcprize_arc-agi_README_2026-08-26.md`, sha256 `26176d96…3864`; `_raw/arc-agi-3-benchmarking_add_anthropic_sdk_2026-08-26.md`, sha256 `684b1489…4e66b`) | ACQUIRED + AUDITED | Arcade params, OperationMode (NORMAL/ONLINE/OFFLINE/COMPETITION), JSONL recording format (STRONG INFERENCE — no formal upstream schema), scorecard + key scope, Anthropic provider YAML verbatim. One stale-doc discrepancy recorded; ⚠️ 0.9.9 behavior caveat on env-var precedence added by the 2026-08-26 audit. |

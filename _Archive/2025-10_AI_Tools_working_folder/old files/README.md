...
git clone https://github.com/michaljesse/narrative-agents.git
cd narrative-agents
...
class NarrativeAgent:
    def __init__(self):
        self.narrative_buffer = deque()  # Core identity memories
        self.substantia = {}              # Essential properties (Aristotle)
        self.accidentia = deque()         # Incidental details
        self.telos = None                 # Purpose/goal (shapes interpretation)
        self.hexis = {}                   # Dispositions/character traits
```
...
- **Heideggerian Throwness**: Distinction between what happens TO us vs what defines us
...
If you use this in academic work (lol):
...
**Michal Valčo**  
Professor of AI Ethics turned Code Philosopher  
*"Making Aristotle compile since 2024"*

- LinkedIn: [/in/michalvalco](https://linkedin.com/in/michalvalco)
- GitHub: [@michaljesse](https://github.com/michaljesse)
